...
<Export
  url={"https://raw.githubusercontent.com/PaloAltoNetworks/docusaurus-openapi-docs/main/demo/examples/petstore.yaml"}
  proxy={undefined}
>
...
<ApiLogo
  logo={{"url":"https://redocly.github.io/redoc/petstore-logo.png","altText":"Petstore logo"}}
  darkLogo={{"url":"/img/petstore-logo-dark.png","altText":"Petstore dark logo"}}
>
